        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16 px-2">
          {stats.map((stat, index) => (
            <div
              ...
              className="reveal-on-scroll reveal-hidden bg-white px-4 py-8 sm:px-6 rounded-[2.5rem] flex flex-col items-center text-center border border-slate-900/5 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] hover:shadow-[0_20px_40px_-12px_rgba(27,54,93,0.12)] hover:border-slate-900/10 hover:-translate-y-2 transition-all duration-500 group"
              style={{ transitionDelay: `${index * 100}ms` }}
            >
              <div className="w-16 h-16 bg-slate-50 rounded-3xl flex items-center justify-center border border-slate-50 mb-6 group-hover:bg-[#1b365d] group-hover:border-[#1b365d] transition-all duration-500 shadow-inner">
                <span className="material-symbols-outlined text-[#1b365d] group-hover:text-white text-3xl font-light transition-colors duration-500">
                  {stat.icon}
                </span>
              </div>
              <div className="flex flex-col items-center gap-2">
                <h4 className="text-lg md:text-xl font-black text-[#1b365d] leading-tight tracking-tight whitespace-nowrap">
                  {stat.value}
                </h4>
                <div className="w-8 h-1 bg-[#e17000]/20 rounded-full group-hover:w-12 group-hover:bg-[#e17000] transition-all duration-500"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
          {facalitiesError && (
            <div className="md:col-span-2 lg:col-span-3 rounded-[2.5rem] bg-red-50 border border-red-100 p-12 text-center reveal-on-scroll reveal-hidden">
              ...
              <p className="grow text-red-600 font-black text-sm uppercase tracking-widest">
                {facalitiesError}
              </p>
            </div>
          )}
          ...
          {isLoadingFacalities &&
            [...Array(3)].map((_, i) => (
              <div
                key={i}
                className="rounded-[2.5rem] bg-slate-50 border border-slate-100 aspect-[4/5] animate-pulse flex flex-col p-8 space-y-6"
              >
            ...
            >
              ...
              <div className="p-8 md:p-10 flex-grow flex flex-col min-w-0">
                ...
                {clampedItems[item.id] && (
                  ...
                  >
                    <span className="text-[10px] font-black text-[#1b365d] uppercase tracking-widest group-hover/btn:text-[#e17000] transition-colors">
                      See Full Description
                    </span>
                    <span className="material-symbols-outlined text-sm text-[#e17000] group-hover/btn:translate-x-1 transition-transform">
                      arrow_right_alt
                    </span>
                  </button>
                )}
