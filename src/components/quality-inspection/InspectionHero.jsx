        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          <div className="space-y-10 animate-fade-in-up">
            ...
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur border border-white/20 rounded-full px-4 py-1.5 text-sm font-medium text-white shadow-sm">
              ...
              <span className="text-[12px]  text-white uppercase tracking-[0.2em]">
                Quality Assurance
              </span>
            </div>
            ...
            <p className="text-lg md:text-xl text-blue-100/80 leading-relaxed max-w-3xl font-medium">
              At Nexturn Componentcraft, quality is built into every stage, not
              just checked at the end. Using advanced tools and a rigorous
              six-stage process, we ensure every metal component—from small
              prototypes to bulk orders—meets international standards with
              micron-level precision and absolute reliability.
            </p>
