        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white border border-slate-100 rounded-xl p-8 shadow-sm flex flex-col h-full">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h3 className="text-xl font-bold text-[#1a2b3c]">Global Availability & Office Hours</h3>
            </div>
            ...
            <div className="mt-6 text-center px-4">
              <p className="text-[9px] leading-relaxed text-slate-400 font-medium">
                We operate  on an extended schedule to ensure seamless communication with our international clients. Our team is always available for real-time consultation during the following windows
              </p>
            </div>
          </div>
