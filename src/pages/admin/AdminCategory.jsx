...
const createEmptyTextListEntry = () => "";
...
const serializeTextListField = (items = []) =>
  JSON.stringify(
    items
...
const AdminCategory = () => {
  ...
  const handleAddNew = () => {
    setEditingCategory({
      ...
      status: "Published",
      applications: [{ text: "" }],
      processDetails: [createEmptyTextListEntry()],
      surfaceFinishes: [createEmptyTextListEntry()],
  ...
  const buildCategoryFormData = (category) => {
    ...
    formData.append("process", serializeTextListField(category.processDetails || []));
    formData.append(
      "surface_finish",
      serializeTextListField(category.surfaceFinishes || []),
    );
  ...
  const openTextListDelete = (type, field, index, fallbackTitle) => {
    const item = editingCategory?.[field]?.[index];
    setDeleteModal({
      isOpen: true,
      id: null,
      type,
      title: String(item || "").trim() || fallbackTitle,
      index,
    });
  };
  ...
  const handleConfirmDelete = async () => {
    ...
    if (deleteModal.type === "application") {
      ...
      removeTextListItem("processDetails", deleteModal.index);
    } else if (deleteModal.type === "surface_finish") {
      removeTextListItem("surfaceFinishes", deleteModal.index);
    }
    setDeleteModal({
      isOpen: false,
      id: null,
  ...
  const renderTextListSection = ({
    ...
    return (
      <div className="relative overflow-hidden bg-white/95 rounded-3xl md:rounded-[2.5rem] p-6 md:p-10 border border-slate-200 shadow-[0_20px_45px_-25px_rgba(15,23,42,0.25)] ring-1 ring-slate-100 space-y-8 transition-all">
        <div className="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-blue-500/50 via-sky-400/40 to-indigo-500/50"></div>
                ...
                >
                  <td className="px-8 py-4">
                    <input
                      ...
                      value={item}
                      onChange={(e) =>
                        updateTextListItem(field, idx, e.target.value)
                      }
                ...
                >
                  <div className="p-6 md:p-8 flex flex-col sm:flex-row gap-6 md:gap-8">
                    ...
                    <div className="flex-1 space-y-4 min-w-0">
                      ...
                      <p className="text-xs font-medium text-black leading-relaxed break-words whitespace-pre-wrap">
                        {cat.description}
                      </p>
          ...
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
              ...
              <div className="lg:col-span-12 space-y-10">
                <div className="relative overflow-hidden bg-white/95 rounded-3xl md:rounded-[2.5rem] p-6 md:p-10 border border-slate-200 shadow-[0_20px_45px_-25px_rgba(15,23,42,0.35)] ring-1 ring-slate-100 grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 transition-all">
                ...
                */}
                ...
                {renderTextListSection({
                  ...
                  itemPlaceholder: "e.g. CNC Turning",
                  deleteType: "process",
                })}
                ...
                {renderTextListSection({
                  ...
                  itemPlaceholder: "e.g. Nickel Plating",
